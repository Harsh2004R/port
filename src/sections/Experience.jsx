...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      achievements: [
        'Built 15+ client projects with 98% client satisfaction rate',
      ...
      technologies: ['Vue.js', 'Express.js', 'MongoDB', 'Redis', 'Tailwind CSS'],
      current: false
    },
    {
      id: 3,
      ...
      technologies: ['React', 'TypeScript', 'Styled Components', 'Webpack', 'Jest'],
      current: false
    },
    {
      id: 4,
  ...
  const education = [
    {
      ...
      duration: '2014 - 2018',
      description: 'Graduated with honors, focusing on software engineering, algorithms, and web technologies.',
      achievements: [
        'Graduated with 8.5/10 CGPA',
        'President of Computer Science Society',
        'Won 3 hackathons during college years',
        'Published 2 research papers in web technologies'
      ]
    }
  ];
    ...
    <section id="experience" className="section-padding bg-gray-50 dark:bg-dark-800">
      <div className="container-custom">
        ...
        >
          ...
          >
            Professional experience, education, and continuous learning in the world of technology
          </motion.p>
        </motion.div>
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {experiences.map((exp, index) => (
                ...
                >
                  {/* Timeline Dot */}
                  <div className={`absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-4 h-4 bg-primary-600 rounded-full border-4 border-white dark:border-dark-800 z-10 ${
